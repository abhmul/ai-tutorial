...
Sourcing: capability descriptions come from official documentation; the cautionary claims are backed by peer-reviewed or primary sources, cited at the end.
...
Caution: AI fabricates references at high rates (figures in Sources). Require retrieval, check every DOI yourself, and cross-check in Google Scholar or PubMed. Retrieval reduces fabrication but does not remove it; human verification is required.
...
Caution: AI is sycophantic — it tends to agree with you, and human raters sometimes prefer a convincing wrong answer (Sources). It also confabulates: confident, invented objections that change when re-asked. Use it as a sparring partner, not an authority; re-ask challenges in a fresh subagent and discount objections that do not survive.
...
- Citation fabrication — Walters, W. H., & Wilder, E. I. (2023). Fabrication and errors in the bibliographic citations generated by ChatGPT. *Scientific Reports* 13:14045. GPT-3.5 fabricated 55% of citations, GPT-4 18%; 24–43% of the real ones still had errors. DOI: 10.1038/s41598-023-41032-5
- Sycophancy — Sharma et al. (2023). Towards Understanding Sycophancy in Language Models. arXiv:2310.13548 (Anthropic).
- Confabulation — Farquhar et al. (2024). Detecting hallucinations in large language models using semantic entropy. *Nature* 630:625–630. DOI: 10.1038/s41586-024-07421-0
...
1. Read the overview and quickstart in the official docs: https://code.claude.com/docs/en/overview. Use the official install steps, not a second-hand command.
2. Learn basic Markdown, the format these tools read and write: https://www.markdownguide.org/basic-syntax/
